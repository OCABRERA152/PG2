...
function displayCalendarSelectBox1(hourInput, minuteInput, buttonObj) {
    var hoy = new Date();
    var año = hoy.getFullYear();
    var m = new Array();
    var mes = hoy.getMonth();
    ...
    //currentMonth = hoy.getMonth().options[hoy.getMonth().selectedIndex].value / 1 - 1;
    //currentYear = año.options[año.selectedIndex].value;
    //if (hourInput) {
    //    currentHour = hourInput.options[hourInput.selectedIndex].value;
    //    inputHour = currentHour / 1;
    //}
    ...
    //hoy.getMonth() = hoy.getMonth().options[hoy.getMonth().selectedIndex].value / 1 - 1;
    //dia = dia.options[dia.selectedIndex].value / 1;
    ...
    returnDateToYear = año;
    returnDateToMonth = hoy.getMonth();
    returnDateToDay = dia;
    returnDateToHour = hourInput;
    returnDateToMinute = minuteInput;
